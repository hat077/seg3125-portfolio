                    ...
                    <div className="col-md-4">
                        <div className="p-4 bg-white shadow-sm rounded h-100">
                            <div className="d-flex align-items-center mb-3">
                                ...
                                <h3 className="fw-bold fs-2 mb-0">01. Architecture</h3>
                            </div>
                            <p>
                                Drawing from my background in software engineering, I approach projects 
                                ...
                                efficient as the interface is functional.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="col-md-4">
                        <div className="p-4 bg-white shadow-sm rounded h-100">
                            <div className="d-flex align-items-center mb-3">
                                ...
                                <h3 className="fw-bold fs-2 mb-0">02. Development</h3>
                            </div>
                            <p>
                                A critical phase of my process is rigorous Quality Assurance. I 
                    ...
                    <div className="col-md-4">
                        <div className="p-4 bg-white shadow-sm rounded h-100">
                            <div className="d-flex align-items-center mb-3">
                                ...
                                <h3 className="fw-bold fs-2 mb-0">03. UI/UX & QA</h3>
                            </div>
                            <p>
                                I am currently a student in the SEG3125: Analysis and Design of User 
                                ...
                                Group (NN/g) to create intuitive and accessible interfaces.
                            </p>
                        </div>
                    </div>
                </div>
